...
import type { VendorCategory, Vendor, Product, Driver, Order, Review, PlatformSettings, Ad, PushCampaign } from "./types";
...
export const ads: Ad[] = [
  {
    ...
    advertiser_id: "v-burhan",
    advertiser_name: "Burhan African Kitchen",
    title: "Authentic Nigerian Jollof Rice — Order Now!",
    description: "Best jollof rice in Manama. Fresh daily.",
    image_url: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=800&q=80",
    target_url: "/store/v-burhan",
    placement_type: "homepage_banner",
    target_zone_ids: ["z-manama", "z-juffair"],
    target_category_ids: ["cat-african-food"],
    target_keywords: ["jollof", "nigerian", "african"],
  ...
  },
  {
    id: "ad-2",
    advertiser_type: "vendor",
    advertiser_id: "v-teranga",
    advertiser_name: "Teranga Senegalese",
    title: "Teranga — Taste of West Africa in Bahrain",
    description: "Thieboudienne, yassa poulet, and more.",
    image_url: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&q=80",
    target_url: "/store/v-teranga",
    placement_type: "sponsored_vendor",
    target_zone_ids: ["z-juffair"],
    target_category_ids: ["cat-african-food"],
    target_keywords: ["senegalese", "thieboudienne"],
    start_date: "2026-05-01",
    end_date: "2026-05-30",
    pricing_model: "fixed_weekly",
    price_fils: 15_000,
    budget_fils: 60_000,
    spent_fils: 30_000,
    status: "active",
  ...
  },
  {
    ...
    advertiser_id: "ext-bahrain-telecom",
    advertiser_name: "Bahrain Telecom Co.",
    title: "eSIM for Africa — Connect from BHD 2",
    description: "Stay connected across Africa with our eSIM plans.",
  ...
  },
  {
    id: "ad-4",
    advertiser_type: "vendor",
    advertiser_id: "v-muharraq-bakery",
    advertiser_name: "Al Muharraq Bakery",
    title: "Muharraq Khameer — Fresh Every Morning",
    description: "Traditional khameer and halwa delivered to your door.",
    image_url: "https://images.unsplash.com/photo-1486887396153-fa416526c108?w=800&q=80",
    target_url: "/store/v-muharraq-bakery",
    placement_type: "category_banner",
    target_zone_ids: ["z-muharraq"],
    target_category_ids: ["cat-bakery"],
    target_keywords: ["khameer", "halwa", "bread"],
    start_date: "2026-05-01",
    end_date: "2026-05-15",
    pricing_model: "cpc",
    price_fils: 50,
  ...
  },
  {
    id: "ad-5",
    advertiser_type: "vendor",
    advertiser_id: "v-pearl-cafe",
    advertiser_name: "Pearl Café",
    title: "Pearl Café — Premium Coffee & African Pastries",
    description: "Zone takeover: Seef area this weekend.",
    image_url: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800&q=80",
    target_url: "/store/v-pearl-cafe",
    placement_type: "zone_takeover",
    target_zone_ids: ["z-seef"],
    target_category_ids: [],
    target_keywords: ["coffee", "café"],
  ...
  },
  {
    id: "ad-6",
    advertiser_type: "vendor",
    advertiser_id: "v-zinj-fashion",
    advertiser_name: "Zinj Fashion House",
    title: "Eid Collection 2026 — Up to 20% off",
    description: "African-inspired fashion for the whole family.",
    image_url: "https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=800&q=80",
    target_url: "/store/v-zinj-fashion",
    placement_type: "push_notification",
    target_zone_ids: [],
    target_category_ids: ["cat-clothes"],
    target_keywords: ["fashion", "eid", "clothes"],
...
export const pushCampaigns: PushCampaign[] = [
  {
    id: "push-1",
    vendor_id: "v-burhan",
    vendor_name: "Burhan African Kitchen",
    title: "🔥 Friday Special — 15% Off All Orders!",
    body: "Order Burhan's jollof rice today and get 15% off. Limited time!",
    target_zone_ids: ["z-manama", "z-juffair"],
    target_category_ids: ["cat-african-food"],
    schedule_at: "2026-05-09T12:00:00Z",
    status: "sent",
    reach: 4_200,
    sent_count: 4_200,
    open_rate_pct: 34.2,
  ...
  },
  {
    id: "push-2",
    vendor_id: "v-teranga",
    vendor_name: "Teranga Senegalese",
    title: "🌍 Weekend Senegalese Feast",
    body: "Try our authentic Thieboudienne this weekend. Free delivery on orders over 8 BHD.",
    target_zone_ids: ["z-juffair", "z-adliya"],
    target_category_ids: [],
    schedule_at: "2026-05-10T11:00:00Z",
    status: "scheduled",
    reach: 2_800,
    sent_count: 0,
    open_rate_pct: 0,
  ...
  {
    id: "push-3",
    vendor_id: "v-zinj-fashion",
    vendor_name: "Zinj Fashion House",
    title: "👗 Eid Collection Now Available!",
    body: "Shop the full Eid 2026 African fashion collection. Fast delivery across Bahrain.",
    target_zone_ids: [],
    target_category_ids: ["cat-clothes"],
    schedule_at: "2026-05-08T09:00:00Z",
    status: "sent",
    reach: 12_000,
    sent_count: 11_840,
    open_rate_pct: 28.7,
...
export function adsByVendor(vendorId: string) { return ads.filter((a) => a.advertiser_id === vendorId); }
export function activeAds(placementType?: Ad["placement_type"]) {
  return ads.filter((a) => a.status === "active" && (!placementType || a.placement_type === placementType));
}
